...
private int type;
    ...
    public CartItemModel(int type, int productImage, String productTitle, int freeCoupon, String productPrice, String cuttedPrice, int productQuantity, int offersApplied, int couponsApplied) {
        this.type = type;
